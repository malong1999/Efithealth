 ...
 * 粉丝列表
 */
public class AdapterOtherFans extends BaseAdapter {
    private Context mContext;
    private List<BeanOtherFans.FollowerlistBean> mList;
    ...
    public AdapterOtherFans( List<BeanOtherFans.FollowerlistBean> list,Context context) {
        mContext = context;
        mList = list;
    }
