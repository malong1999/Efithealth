package com.maxiaobu.healthclub.unuse;
...
import com.maxiaobu.healthclub.unuse.bean.Cell;
import com.maxiaobu.healthclub.unuse.bean.ColTitle;
import com.maxiaobu.healthclub.unuse.bean.RowTitle;
...
public class CustomAdapter extends BaseExcelPanelAdapter<RowTitle, ColTitle, Cell> {
    ...
    public void onBindCellViewHolder(RecyclerView.ViewHolder holder, int verticalPosition, int horizontalPosition) {
        ...
        if (cell.getStatus() == 0) {
            ...
            if (cell.getStatus() == 1) {
                viewHolder.cellContainer.setBackgroundColor(ContextCompat.getColor(context, R.color.orange));
            } else if (cell.getStatus() == 2) {
                viewHolder.cellContainer.setBackgroundColor(ContextCompat.getColor(context, R.color.gray));
            } else {
                viewHolder.cellContainer.setBackgroundColor(ContextCompat.getColor(context, R.color.gray444444));
            }
        }
    }
