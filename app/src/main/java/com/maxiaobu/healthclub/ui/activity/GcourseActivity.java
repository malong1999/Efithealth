...
//            Toast.makeText(context, "gotoBespeakList", Toast.LENGTH_SHORT).show();
            ...
            startActivity(intent);
            //http://192.168.1.121:8080/efithealth/mcoursebuysave.do?gcalid=G000052&memid=M000455
...
//        Log.i(TAG, "onPermissionsDenied: "+ requestCode + ":" + perms.size());
    ...
    public void onPermissionsDenied(int requestCode, List<String> perms) {
        EasyPermissions.checkDeniedPermissionsNeverAskAgain(this, "点设置---》权限---》权限给我", R.string.setting, R.string.cancel, perms);
    }
