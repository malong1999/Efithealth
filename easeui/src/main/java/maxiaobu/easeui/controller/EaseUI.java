...
public final class EaseUI {
    ...
    /**
     * check the application process name if process name
     * is not qualified, then we think it is a service
     * process and we will not init SDK
     * @param pID
     * @return
     */
    private String getAppName(int pID) {
        ...
        while (i.hasNext()) {
            ActivityManager.RunningAppProcessInfo info = (ActivityManager
