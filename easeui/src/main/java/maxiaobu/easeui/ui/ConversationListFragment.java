...
//    private EntoListener mListner;
    ...
    protected void setUpView() {
        conversationList.addAll(loadConversationList(type));
...
//                    mEntoListener.ento(conversation);
     ...
     * @return
    +    */
    protected List<EMConversation> loadConversationList(int type){
        // get all conversations
        final Map<String, EMConversation> conversations = EMClient.getInstance().chatManager().getAllConversations();
//        RelativeLayout ly_root= (RelativeLayout) mRootView.findViewById(R.id.ly_no_conversation);
        MaterialRippleLayout mLayout = (MaterialRippleLayout) mRootView.findViewById(R.id.group_layout);
